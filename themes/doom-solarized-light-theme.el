...
(def-doom-theme doom-solarized-light
  ...
  ((elscreen-tab-other-screen-face :background "#353a42" :foreground "#1e2022")
   ...
   ;; ivy-mode
   (ivy-current-match :background (doom-darken bg 0.02) :distant-foreground fg)
   (ivy-minibuffer-match-face-1
    :foreground comments
    :weight 'light)
   (ivy-minibuffer-match-face-2 :foreground magenta :background (doom-blend magenta base3 0.1) :weight 'bold)
   (ivy-minibuffer-match-face-3 :foreground green   :background (doom-blend green base3 0.1) :weight 'bold)
   (ivy-minibuffer-match-face-4 :foreground yellow  :background (doom-blend yellow base3 0.1) :weight 'bold)
