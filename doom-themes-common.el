...
(defun doom-themes-common-faces ()
  ...
  '(;; --- custom faces -----------------------
    ...
    (treemacs-directory-collapsed-face :foreground blue :font "SF Compact Display")
    (treemacs-directory-face           :foreground blue :font "SF Compact Display")
    (treemacs-file-face                :foreground fg :font "SF Compact Display")
    (treemacs-git-added-face           :foreground fg :font "SF Compact Display")
    (treemacs-git-conflict-face        :foreground fg :font "SF Compact Display")
    (treemacs-git-ignored-face         :foreground fg :font "SF Compact Display")
    (treemacs-git-modified-face        :foreground fg :font "SF Compact Display")
    (treemacs-git-renamed-face         :foreground fg :font "SF Compact Display")
    (treemacs-git-unmodified-face      :foreground fg :font "SF Compact Display")
    (treemacs-git-untracked-face       :foreground fg :font "SF Compact Display")
    (treemacs-help-column-face         :foreground fg :font "SF Compact Display")
    (treemacs-help-title-face          :foreground fg :font "SF Compact Display")
    ...
    (treemacs-tags-face                :foreground green :weight 'light :font "SF Compact Display")
